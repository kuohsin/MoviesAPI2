...
(function () {
    ...
    ***************************************************************************** */
    ...
    var GEOLOCATION_DIALOG_TYPE = 'geolocation';
    var NativeDialogTracker = /** @class */ (function () {
        ...
        NativeDialogTracker.prototype._handleGeolocationDialog = function (successCallback, failCallback) {
            ...
            var url = NativeDialogTracker._getPageUrl();
            var isFirstGeolocationRequest = !nativeMethods.arraySome
                .call(this.appearedDialogs, function (dialog) { return dialog.type === GEOLOCATION_DIALOG_TYPE && dialog.url === url; });
        ...
        NativeDialogTracker.prototype._setCustomOrDefaultHandler = function () {
            var _this = this;
        ...
        NativeDialogTracker.prototype._setGeolocationDialogHandler = function () {
            var _a, _b;
            var geolocationPrototype = (_a = window.Geolocation) === null || _a === void 0 ? void 0 : _a.prototype;
            var geolocationObject = (_b = window.navigator) === null || _b === void 0 ? void 0 : _b.geolocation;
        ...
        NativeDialogTracker.prototype._shouldOverrideGeolocationDialog = function (geolocation) {
            if (!(geolocation === null || geolocation === void 0 ? void 0 : geolocation.getCurrentPosition))
                return false;
            var isNativeMethod = nativeMethods.isNativeCode(geolocation.getCurrentPosition);
            var isNativeDialogHandler = geolocation.getCurrentPosition === this._handleGeolocationDialog;
    ...
    var Driver = /** @class */ (function (_super) {
        ...
        Driver.prototype._createDispatchNativeAutomationEventFn = function (name) {
            return nativeMethods$6.functionBind.call(testcafeCore.browser[name], testcafeCore.browser[name], this.communicationUrls[name], hammerhead__default.createNativeXHR);
        };
        // Commands handling
        ...
        Driver.prototype._init = function () {
            ...
            this.statusBar = new testCafeUI__default.StatusBar(this.runInfo.userAgent, this.runInfo.fixtureName, this.runInfo.testName, this.contextStorage, nativeAutomation);
