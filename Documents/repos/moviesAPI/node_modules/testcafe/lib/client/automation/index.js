...
(function () {
    ...
    ***************************************************************************** */
    ...
    function getElementFromPoint(_a) {
        var x = _a.x, y = _a.y;
        // @ts-ignore
        var func = document.elementFromPoint;
        var el = null;
        try {
    ...
    var CDPEventDescriptor = /** @class */ (function () {
        ...
        CDPEventDescriptor.createTouchEventOptions = function (type, options) {
            return __awaiter(this, void 0, void 0, function () {
                var _a, x, y;
                return __generator(this, function (_b) {
                    switch (_b.label) {
    ...
    var TOUCH_MODE = hammerhead__default.utils.featureDetection.isTouchDevice;
    var NativeAutomationInput = /** @class */ (function () {
        ...
        NativeAutomationInput.prototype._executeTouchEvent = function (touchEvent, options) {
            return __awaiter(this, void 0, void 0, function () {
                var eventOptions;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, CDPEventDescriptor.createTouchEventOptions(touchEvent, options)];
                        case 1:
                            eventOptions = _a.sent();
                            return [2 /*return*/, this._dispatchEventFn.single(EventType.Touch, eventOptions)];
                    }
                });
            });
        };
        NativeAutomationInput.prototype._executeMouseEvent = function (mouseEvent, options) {
            return __awaiter(this, void 0, void 0, function () {
                var eventOptions;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, CDPEventDescriptor.createMouseEventOptions(mouseEvent, options)];
                        case 1:
                            eventOptions = _a.sent();
        ...
        NativeAutomationInput.prototype.mouseDown = function (options) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    if (TOUCH_MODE)
                        return [2 /*return*/, this._executeTouchEvent('touchStart', options)];
                    return [2 /*return*/, this._executeMouseEvent('mousePressed', options)];
                });
            });
        };
        NativeAutomationInput.prototype.mouseUp = function (options) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    if (TOUCH_MODE)
                        return [2 /*return*/, this._executeTouchEvent('touchEnd', options)];
                    return [2 /*return*/, this._executeMouseEvent('mouseReleased', options)];
                });
            });
        };
    ...
    var MouseClickStrategy = /** @class */ (function () {
        ...
        MouseClickStrategy.prototype.mousedown = function (eventArgs) {
            ...
            var needCloseSelectDropDown = browserUtils$3.isWebKit && domUtils$3.isSelectElement(this.mouseDownElement);
    ...
    var SelectChildClickAutomation = /** @class */ (function () {
        ...
        SelectChildClickAutomation.prototype._mouseup = function () {
            eventSimulator$6.mouseup(this.eventsArgs.element, this.eventsArgs.options);
    ...
    function _updateSelectionAfterDeletionContent(element, selection) {
        ...
        var browserRequiresSelectionUpdating = browserUtils$5.isChrome && browserUtils$5.version < 58 || browserUtils$5.isSafari;
    ...
    function simulateTextInput(element, text) {
        ...
        var isInputEventRequired = browserUtils$5.isFirefox || eventSimulator$9.textInput(element, text) || forceInputInSafari;
        if (browserUtils$5.isSafari) {
    ...
    function _typeTextToContentEditable(element, text) {
        ...
        if (!startNode || !domUtils$7.isContentEditableElement(startNode) || !domUtils$7.isRenderedNode(startNode))
            return;
        if (!simulateBeforeInput(element, text, browserUtils$5.isChrome || browserUtils$5.isFirefox))
            return;
        beforeContentChanged();
        if (needProcessInput)
            needProcessInput = simulateBeforeInput(element, text, browserUtils$5.isSafari);
        if (needProcessInput) {
    ...
    function _typeTextToTextEditable(element, text) {
        ...
        var elementMaxLength = isInputTypeNumber ? null : parseInt(element.maxLength, 10);
        ...
        if (elementMaxLength === null || isNaN(elementMaxLength) || elementMaxLength >= newElementValue.length) {
            // NOTE: B254013
            if (isInputTypeNumber && browserUtils$5.isIOS && elementValue[elementValue.length - 1] === '.') {
                startSelection += 1;
                endSelection += 1;
            }
    ...
    function getFocusableElementsFilter(sourceElement, skipRadioGroups) {
        ...
        if (skipRadioGroups) {
            ...
            if (sourceElement.name !== '' && !browserUtils$6.isFirefox)
        ...
        else if (browserUtils$6.isChrome)
    ...
    function filterFocusableElements(elements, sourceElement, skipRadioGroups) {
        if (!isRadioButtonElement$1(sourceElement))
            return elements;
        if (!skipRadioGroups && !sourceElement.name && !browserUtils$6.isChrome)
    ...
    var KeyPressSimulator = /** @class */ (function () {
        ...
        KeyPressSimulator.prototype._type = function (element, char) {
            ...
            if (elementChanged) {
                ...
                shouldType = (!browserUtils$7.isFirefox || isStoredElementEditable) &&
                    (!browserUtils$7.isWebKit || shouldTypeInWebKit);
            }
            if (shouldType) {
        ...
        KeyPressSimulator.prototype.press = function (modifiersState) {
            ...
            if (browserUtils$7.isWebKit && elementChanged) {
            ...
            this._addKeyPropertyToEventOptions(eventOptions);
            var raiseDefault = browserUtils$7.isAndroid || eventSimulator$a.keypress(activeElement, extend$2(eventOptions, modifiersState));
            if (!raiseDefault)
                return raiseDefault;
            ...
            var isSafariWithAutoRaisedClick = browserUtils$7.isSafari &&
                browserUtils$7.compareVersions([browserUtils$7.webkitVersion, '603.1.30']) >= 0;
        ...
        KeyPressSimulator.prototype.up = function (modifiersState) {
            ...
            var emulateClick = !browserUtils$7.isSafari &&
                (!browserUtils$7.isChrome || browserUtils$7.version >= 53);
    ...
    function up(element) {
        ...
        if (isRadioButtonNavigationRequired(element))
            return focusAndCheckNextRadioButton(element, true);
        if (browserUtils$8.isWebKit && domUtils$8.isInputElement(element))
            return home(element);
        if (domUtils$8.isTextAreaElement(element))
    ...
    function scrollEditableElementByPoint(element, point) {
        ...
        if (isInputElement && browserUtils$9.isFirefox)
            return;
        var elementOffset = positionUtils$4.getOffsetPosition(element);
        var elementBorders = styleUtils$6.getBordersWidth(element);
    ...
    function excludeElementScroll(element, point) {
        ...
        if (isInputElement && isTextEditable && browserUtils$9.isFirefox) {
            return {
    ...
    var SelectBaseAutomation = /** @class */ (function (_super) {
        ...
        SelectBaseAutomation.prototype._mousedown = function () {
            ...
            return cursor
                ...
                // NOTE: In WebKit, the mousedown event opens the select element's dropdown;
                // therefore, we should prevent mousedown and hide the dropdown (B236416).
                var needCloseSelectDropDown = browserUtils$a.isWebKit && domUtils$b.isSelectElement(_this.element);
                if (needCloseSelectDropDown)
    ...
    var TypeAutomation = /** @class */ (function () {
        ...
        TypeAutomation.prototype._keypress = function () {
            ...
            this.eventState.simulateTypeChar = browserUtils$b.isAndroid || eventSimulator$e.keypress(this.eventArgs.element, this.eventArgs.options);
        };
