    ...
    ***************************************************************************** */
    ...
    function canFocus(element, parent, tabIndex) {
        ...
        if (getElementStyleProperty(element, 'display') === 'none' || getElementStyleProperty(element, 'visibility') === 'hidden')
            return false;
        if (browserUtils$1.isAndroid && isOptionElement(element))
            return false;
    ...
    function filterFocusableElements(parent) {
        ...
        for (var i = 0; i < allElements.length; i++) {
            ...
            var needPush = inputElementsRegExp.test(tagName)
                || element.shadowRoot
    ...
    function checkBrowserHotkey(e) {
        ...
        return e.shiftKey && e.ctrlKey || (e.altKey || e.metaKey) && browserUtils$2.isMacPlatform || e.keyCode === F12_KEY_CODE;
    }
    ...
    var SelectController = /** @class */ (function () {
        ...
        SelectController.prototype._createOption = function (realOption, parent) {
            ...
            nativeMethods$4.nodeTextContentSetter.call(option, text);
        ...
        SelectController.prototype._createGroup = function (realGroup, parent) {
            ...
            nativeMethods$4.nodeTextContentSetter.call(group, realGroup.label || ' ');
    ...
    function getSelectedPositionInParentByOffset(node, offset) {
        ...
        var currentNode = childNodes[offset];
        var currentOffset = 0;
    ...
    function selectByNodesAndOffsets(startPos, endPos, needFocus) {
        ...
        var selectionSetter = function () {
            ...
            if (!inverse) {
                ...
                selection.addRange(range);
                var shouldCutEndOffset = browserUtils$3.isSafari || browserUtils$3.isChrome && browserUtils$3.version < 58;
    ...
    var TEMPLATES = (_a = {},
        ...
        _a[RUNTIME_ERRORS.roleInitializedWithRelativeUrl] = 'Your Role includes a relative login page URL, but the "baseUrl" option is not set.\nUse an absolute URL or add the baseUrl option to your configuration file or CLI launch string.',
